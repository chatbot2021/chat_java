...
var DemoAdapterConstants = (function () {
    ...
    DemoAdapterConstants.ECHOBOT_REPLY_DELAY = 5000;
...
var DemoServerAdapter = (function () {
    function DemoServerAdapter(clientAdapter) {
        ...
        myUser.ProfilePictureUrl = "/SpringMVCloginExample/resources/images/default_profile_img.png";
        ...
        echoBotUser.Name = "SupportBot";
        echoBotUser.Email = "echobot1984@gmail.com";
        echoBotUser.ProfilePictureUrl = "/SpringMVCloginExample/resources/images/bank-logo.png";
